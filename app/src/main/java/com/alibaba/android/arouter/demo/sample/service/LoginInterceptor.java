package com.alibaba.android.arouter.demo.sample.service;
...
import com.alibaba.android.arouter.demo.sample.UserHelper;
...
public class LoginInterceptor implements IInterceptor {
    ...
    public void process(Postcard postcard, InterceptorCallback callback) {
        if (!UserHelper.get().isLogin() && paths.contains(postcard.getPath())) {
            ...
            AppRouter.skip(AppPaths.APP_LOGIN, bundle);
            return;
        }
